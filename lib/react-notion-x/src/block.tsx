...
export const Block: React.FC<BlockProps> = (props) => {
  ...
  switch (block.type) {
              ...
              <div className="notion-frame">
                ...
                <div className="notion-page-scroller">
                  ...
                  >
                    ...
                    >
                      <motion.div className="motion" variants={blockVariants}>
    ...
    case 'text': {
      ...
      return (
        <motion.div
          ...
          viewport={{ once: true, amount: 0.8 }}
        >
          <motion.div className="motion" variants={textVariants}>
            <div
              className={cs(
                'notion-text',
                blockColor && `notion-${blockColor}`,
    ...
    case 'column': {
      ...
      return (
        <>
          <div className={cs('notion-column-test', blockId)} style={style}>
            {children}
          </div>
