...
export default function Card() {
    return (
        <article>
            <h1>Card</h1>
            <br/>
            <p>The <strong>Card</strong> component is an element used to display information in a concise and visually
                appealing
            ...
            <p className='component-property-desc'><code>Status</code> - Information about the campaign’s status</p>

            <p className='component-property-desc'><code>Label</code> - The title or name of the campaign.</p>

            <p className='component-property-desc'><code>Secondary Text</code> - Contains additional information such as
                the
                campaign's start date, end
                date, or any other relevant details that provide context.</p>

            <p className='component-property-desc'><code>Additional Information</code> - This can include buttons and
                the
            ...
            <p className='component-property-desc'><code>Avatar</code> - an image that represents a user</p>

            <p className='component-property-desc'><code>Status</code> - Information about the creator's status</p>

            <p className='component-property-desc'><code>Additional Information</code> - Varies by location. In a
                campaign
            ...
            <p className='component-property-desc'><code>Platform</code> - an accompanying icon identifies the platform
                from
                which the post originates,
                helping users recognize the content's source.</p>

            <p className='component-property-desc'><code>Hover Metrics (Desktop Version)</code> - in the desktop
                version,
            ...
            <p className='component-property-desc gray-link'>
                <code>User Block</code><span> - Go to the </span>
                <Link
                    href='https://www.notion.so/User-Block-2e21ab38c19e404aa0fe0741e349d71a?pvs=21'>documentation</Link>.
            </p>

            <p className='component-property-desc'><code>Chart</code> - Optionally, a visual representation like a chart
                or
                graph to illustrate trends
                or comparisons.</p>

            <p className='component-property-desc'><code>Data Table</code> - A table containing relevant data or
                statistics.
            </p>
            ...
            <p className='component-property-desc'><code>Title</code> - It is important that the name is clear, concise,
                and
                descriptive of the
                template’s purpose or content to assist the user in making an informed
                selection.</p>

            <p className='component-property-desc'><code>Icon</code> - An optional feature, an icon can be added to the
                label
                to provide
            ...
            <p className='component-property-desc'><code>Description</code> - This provides further information about
                the
                template. This could
