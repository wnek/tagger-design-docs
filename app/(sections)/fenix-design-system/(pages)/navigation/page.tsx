...
export default function Navigation() {
    return (
        <article>
            ...
            <p className='component-property-desc'><code>Breadcrumbs</code> - are a navigational aid that displays the
                user's
            ...
            <p className='component-property-desc'><code>Top-Bar-Text with Button</code> - this section may contain
                specific
            ...
            <p className='component-property-desc'><code>Buttons Group</code> - the button groups contain buttons that
                relate
            ...
            <p className='component-property-desc'><code>Label</code> - provides a concise description of the
                destination
                page
                or section. It's the text that
                users will read to understand where the link will take them.</p>

            <p className='component-property-desc'><code>Icon</code> - can accompany the label to provide a visual cue
                or
            ...
            <p>The example of the main navigation on the platform.</p>
